        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="{{ asset("/bower_components/inspinia/assets/img/profile_small.jpg") }}" />
                             </span>
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">{{ Confide::user()->username }}</strong>
                             </span> <span class="text-muted text-xs block">{{Confide::user()->roles()->first()->name}} <b class="caret"></b></span> </span> </a>
            ...
            <li>
                <a href="index.html"><i class="fa fa-users"></i> <span class="nav-label">Manage users</span></a>
            </li>
            <li>
